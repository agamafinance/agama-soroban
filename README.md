...
| Allocation Engine | [`CCSI33BM...FHVJCW`](https://stellar.expert/explorer/testnet/contract/CCSI33BM4HILB5UGTAZPAW6F7EGF57YG2HEYABNASMCQ4YXKPOFHVJCW) |
...
|---|---|---|---|
| Private Credit | QIRO | LU | [`CA24YZ2N...EJ4MSR`](https://stellar.expert/explorer/testnet/contract/CA24YZ2NP2X5NRL3VPUU3APCHNIF4HA765RXTMDIBYGKMEKRXEEJ4MSR) |
| Etherfuse | ETHERFUS | MX | [`CAYOGJ35...5PV2NF`](https://stellar.expert/explorer/testnet/contract/CAYOGJ35O5LIULVSGIWIGGMUQS7SDXFF7BLFQK63X62WPLBTMD5PV2NF) |
...
|---|---|---|
| agUSD (`contracts/agusd`), first deployment | [`CCXEP6QA...HNQ6H3`](https://stellar.expert/explorer/testnet/contract/CCXEP6QAAYEMFMV2JGBULD2NS6AQB6KQSBHLPPBJSDBCN6HOYIHNQ6H3) | Generation 1 agUSD is a self contained vault, not a plain token: it mints only inside its own deposit() and exposes no mint entry point, so the Vault cannot mint against a deposit. It stays deployed, it keeps its holders, and it is still the token the deployed sagUSD staking contract accepts. |
